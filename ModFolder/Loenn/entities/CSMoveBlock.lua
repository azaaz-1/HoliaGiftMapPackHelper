...
csmoveBlock.name = "HoliaGiftMapPackHelper/CSMoveBlock"
csmoveBlock.depth = 8995
csmoveBlock.minimumSize = {16, 16}
csmoveBlock.fieldInformation = {
    direction = {
        options = moveBlockDirections,
        editable = false
    }
}
csmoveBlock.placements = {}
...
for _, direction in ipairs(moveBlockDirections) do
    for steerable = 1, 2 do
        for fast = 1, 2 do
            ...
            table.insert(csmoveBlock.placements, {
                name = name,
                data = {
                    width = 16,
                    height = 16,
                    ...
                    pressedColor = "30b335",
                    breakColor = "cc2541",
                    returntoInitDirection = returntoInitDirection == 0,
                    startFlag = ""
                }
            })
        end
...
function csmoveBlock.sprite(room, entity)
